...
[CGpipe](/projects/cgpipe/) is a powerful tool for executing bioinformatics data analysis workflows. Much
...
executing jobs, such as in the context of a Docker container. The way we'll explore executing
...
One way to do this would be to use [ngsutilsj](/projects/ngsutilsj/) and run the following:
...
Here is what our trivial example looks like as a cgpipe script:
...
as the first thing on a line without any preceding whitespace. If you use consistent indentation, this normally
